...
Button fButtonYes,fButtonNo;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fButtonYes=view.findViewById(R.id.yesbtn);
        fButtonNo=view.findViewById(R.id.no);
        fButtonNo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dismiss();
            }
        });
        fButtonYes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                sharedManeger.logoutuser();
